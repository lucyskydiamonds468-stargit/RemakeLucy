...
if __name__ == '__main__':
    logger.info("RemakeLucy v1.0 発進！ 船長@hystericloudの貧乏人魂が黄金ジャンボ船に！")
    logger.info(f"ETHUSDT Grid起動 | 資金: {TOTAL_INVESTMENT*94600:.0f}USDT | 目標: 1000USDT")
    engine.run()
